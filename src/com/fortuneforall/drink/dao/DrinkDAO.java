...
//			}
	...
	public void insertDrink(Drink drink) {
		...
		try {
			con = ConnectionPool.getConnection();
			StringBuffer sql = new StringBuffer();
			sql.append("insert into tb97_board(board_no,member_no,title,content,table_type) values(s_board_no.nextval,(select member_no from tb97_member where id=?),?,?,1)");
			
			stmt = con.prepareStatement(sql.toString());
			
			stmt.setString(1, drink.getWriter());
			stmt.setString(2, drink.getTitle());
			stmt.setString(3, drink.getContent());
