...
<div class="panel panel-default">
  ...
  <div class="panel-body">
  	<div class="container">
  <p>게시글을 작성하는 곳입니다</p>
  <form action="/FortuneForAll/com.fortuneforall.drink.controller/DrinkUpdateController">
  제목<br>
...
<br>
 ...
 <br><br>
  <textarea rows="16" cols="200" name="content"> <c:out value = "${drink.content}" /></textarea>
  <button name="n" value="${drink.board_no}">저장</button>
