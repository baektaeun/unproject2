	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="container">
				...
				<br>
				<p align="left">
					<button type="button" onclick="location.href='/FortuneForAll/com.fortuneforall.drink.controller/DrinkSelectController?page=1'">수정</button>
				</p>
				<p align="right">
				<%
					if(result==0) {
						%>
				<form method="POST"
					action="/FortuneForAll/com.fortuneforall.drink.controller/DrinkUpWriteController?id=${id}&num=${board.board_no}&content=${board.content}&title=${board.title}">
					<button>수정</button>
				</form>
				<form method="POST"
					action="/FortuneForAll/com.fortuneforall.drink.controller/DrinkDeleteController?num=${board.board_no}">
					<button>삭제</button>
				</form>
						<%
					}
